...
Java_com_wikitude_samples_advanced_plugins_MarkerTrackingPluginExtension_setDefaultDeviceOrientationLandscape(JNIEnv* env, jobject obj, jboolean isLandscape)
{
    MarkerTrackingPlugin::instance->setDefaultOrientationLandscape(isLandscape);
}

extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_MarkerTrackingPluginExtension_initNative(JNIEnv* env, jobject obj)
{
...
void MarkerTrackingPlugin::update(const wikitude::sdk::RecognizedTargetsBucket& recognizedTargetsBucket_)
{
}
