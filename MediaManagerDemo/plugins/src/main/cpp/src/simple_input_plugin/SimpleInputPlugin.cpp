...
Java_com_wikitude_samples_advanced_plugins_input_SimpleInputPluginExtension_initNative(JNIEnv* env, jobject obj) {
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_input_SimpleInputPluginExtension_setImageSensorRotation(JNIEnv* env, jobject obj, jint rotation) {
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_input_SimpleInputPluginExtension_setCameraFieldOfView(JNIEnv* env, jobject obj, jfloat fieldOfView) {
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_input_SimpleInputPluginExtension_setFrameSize(JNIEnv* env, jobject obj, jint frameWidth, jint frameHeight) {
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_input_SimpleInputPluginExtension_notifyNewCameraFrame(
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_input_SimpleInputPluginExtension_notifyNewCameraFrameN21(JNIEnv* env, jobject obj, jbyteArray cameraFrame) {
    int frameSize = -1;
