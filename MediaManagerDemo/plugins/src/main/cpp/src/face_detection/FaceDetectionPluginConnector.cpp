...
Java_com_wikitude_samples_advanced_plugins_FaceDetectionPluginExtension_initNative(JNIEnv* env, jobject obj)
{
...
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_FaceDetectionPluginExtension_destroyNative(JNIEnv* env, jobject obj)
{
...
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_FaceDetectionPluginExtension_setDatabase(JNIEnv* env, jobject obj, jstring databasePath_)
{
    FaceDetectionPlugin::_databasePath = env->GetStringUTFChars(databasePath_,NULL);
}

extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_FaceDetectionPluginExtension_setIsBaseOrientationLandscape(JNIEnv* env, jobject obj, jboolean isBaseOrientationLandscape_)
{
...
void FaceDetectionPluginConnector::faceDetected(const float *modelViewMatrix)
{
    ...
    jclass clazz = vm.env->FindClass("com/wikitude/samples/advanced/plugins/FaceDetectionPluginExtension");
