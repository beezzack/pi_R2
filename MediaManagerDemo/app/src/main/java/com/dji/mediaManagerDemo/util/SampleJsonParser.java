...
import com.dji.mediaManagerDemo.WikitudeGeoArActivity;
import com.dji.mediaManagerDemo.advanced.ArchitectViewExtensionActivity;
            ...
            for (int i = 0; i < categoryArray.length(); i++) {
                ...
                for (int u = 0; u < samplesArray.length(); u++) {
                    ...
                    if (extensions != null) {
                        ...
                        activityClass = WikitudeGeoArActivity.class;
                    } else {
                        activityClass = WikitudeArActivity.class;
                    }
