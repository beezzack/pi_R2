package com.dji.mediaManagerDemo.advanced;


import com.dji.mediaManagerDemo.advanced.plugins.input.SimpleInputPluginExtension;
...
import com.dji.mediaManagerDemo.advanced.plugins.FaceDetectionPluginExtension;
import com.dji.mediaManagerDemo.advanced.plugins.MarkerTrackingPluginExtension;
import com.dji.mediaManagerDemo.advanced.plugins.QrPluginExtension;
import com.dji.mediaManagerDemo.advanced.plugins.input.CustomCameraExtension;
...
public class ArchitectViewExtensionActivity extends WikitudeArActivity {
    ...
    private CustomCameraExtension cusCamera;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SampleData sampleData = (SampleData) intent.getSerializableExtra(WikitudeArActivity.INTENT_EXTRAS_KEY_SAMPLE);
        ...
        for (String extension : sampleData.getExtensions()) {
            switch (extension) {
                ...
                case EXTENSION_CUSTOM_CAMERA:
                    cusCamera = new CustomCameraExtension(this, architectView);
