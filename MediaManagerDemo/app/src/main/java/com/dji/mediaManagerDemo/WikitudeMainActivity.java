...
import com.dji.mediaManagerDemo.util.PermissionUtil;
import com.dji.mediaManagerDemo.util.SampleCategory;
import com.dji.mediaManagerDemo.util.SampleData;
import com.dji.mediaManagerDemo.util.SampleJsonParser;
import com.dji.mediaManagerDemo.util.adapters.SamplesExpendableListAdapter;
import com.dji.mediaManagerDemo.util.urllauncher.UrlLauncherStorageActivity;
 ...
 */
public class WikitudeMainActivity extends AppCompatActivity implements ExpandableListView.OnChildClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wikitudemain);
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        ...
        permissionManager.checkPermissions(WikitudeMainActivity.this, permissions, PermissionManager.WIKITUDE_PERMISSION_REQUEST, new PermissionManager.PermissionManagerCallback() {
            @Override
            public void permissionsGranted(int requestCode) {
                final Intent intent = new Intent(WikitudeMainActivity.this, sampleData.getActivityClass());
                intent.putExtra(WikitudeArActivity.INTENT_EXTRAS_KEY_SAMPLE, sampleData);
            ...
            public void permissionsDenied(@NonNull String[] deniedPermissions) {
                Toast.makeText(WikitudeMainActivity.this, getString(R.string.permissions_denied) + Arrays.toString(deniedPermissions), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void showPermissionRationale(final int requestCode, @NonNull String[] strings) {
                final AlertDialog.Builder alertBuilder = new AlertDialog.Builder(WikitudeMainActivity.this);
    ...
    public void showSdkBuildInformation(MenuItem item) {
        ...
        new AlertDialog.Builder(WikitudeMainActivity.this)
