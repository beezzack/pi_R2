var World = {
    ...
    createOverlays: function () {
         ...
         */
        var targetCollectionResource = new AR.TargetCollectionResource("assets/phototarget.wtc");
...
//            onTargetsLoaded: this.worldLoaded,
         ...
         */
        new AR.Model("assets/5heart.wt3");
        new AR.Model("assets/runtrain.wt3");
        ...
        new AR.ImageTrackable(tracker, "*", {
            onImageRecognized: function (target) {
                 ...
                 */
                if(target.name[0]=="s"){
                    this.model = new AR.Model("assets/5heart.wt3", {
                        scale: {
                            x: 0.015,
                            y: 0.015,
                            z: 0.015
                     ...
                     */
                    this.addImageTargetCamDrawables(target, this.model);
                    var animationfly = new AR.ModelAnimation(this.model, "Vert|VertAction");
                    animationfly.start(5000);
...
//                    World.removeLoadingBar();
                ...
                else if(target.name[0]=="o"){
                    this.model = new AR.Model("assets/runtrain.wt3", {
                        scale: {
                            x: 0.007,
                            y: 0.007,
                            z: 0.007
                     ...
                     */
                    this.addImageTargetCamDrawables(target, this.model);
                    var animationfly = new AR.ModelAnimation(this.model, "SteaDum|SteaDumAction");
                    animationfly.start(5000);
