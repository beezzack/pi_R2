var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		this.targetCollectionResource = new AR.TargetCollectionResource("assets/park.wto", {
			onLoaded: function () {
...
//			onTargetsLoaded: this.loadingStep,
		...
		*/
		this.modelCar = new AR.Model("assets/5heart.wt3", {
//			onLoaded: this.loadingStep,
		...
		this.animationfly = new AR.ModelAnimation(this.modelCar, "Vert|VertAction");
...
//		this.appearingAnimation = this.createAppearingAnimation(this.modelCar, 0.045);
		...
		*/
		var trackable = new AR.ObjectTrackable(this.tracker, "*", {
			drawables: {
				cam: [this.modelCar]
			},
			onObjectRecognized: this.appear,
			onObjectLost: this.disappear,
            onError: function(errorMessage) {
            	alert(errorMessage);
            }
		});
